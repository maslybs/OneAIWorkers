...
Ця кнопка лишається додатковим способом для розробників. Вона вимагає GitHub або GitLab. Для звичайних користувачів використовуйте [встановлювач OneAIWorkers](https://workers.bgdn.dev/?lang=uk).
...
Worker підтримує OAuth для ChatGPT. OAuth, дані плагінів, схеми дій, пошук, права й записи аудиту зберігаються у D1, яку Cloudflare створює під час розгортання.
