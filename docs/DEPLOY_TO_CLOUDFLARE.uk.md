...
Ця кнопка лишається додатковим способом для розробників. Вона вимагає GitHub або GitLab. Для звичайних користувачів використовуйте [встановлювач без GitHub](INSTALLER.uk.md).
