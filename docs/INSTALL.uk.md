...
Йому не потрібна база даних для памʼяті AI. AI-помічник сам памʼятає дані й вирішує, що робити. OneAIWorkers використовує невелику D1 базу тільки для OAuth-клієнтів і токенів.
