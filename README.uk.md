...
Ці дві постійні команди завжди читають живий реєстр. Керування конекторами доступне через `connector_id: system`, Workers AI та агенти — через `connector_id: native`, а встановлені сервіси — через власні ID.
