...
Для звичайних користувачів основний спосіб — [встановлювач без GitHub](docs/INSTALLER.uk.md). Власник проєкту розгортає його один раз, а користувач далі входить лише в Cloudflare і натискає **Встановити**.
...
Докладно для власника проєкту: [встановлювач без GitHub](docs/INSTALLER.uk.md).
